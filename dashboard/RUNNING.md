...
by design) and 2 (`Home.py`, `views/18_Mantenimiento.py`) render as "clean"
...
- `views/04_Desgloses.py` has a mojibake character (`�`) in its selector
  help text — cosmetic, an encoding artifact in the source string.
- `views/06_Puntajes.py` shows "No daily activity data yet" even though
