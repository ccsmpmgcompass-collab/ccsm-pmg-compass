...
_APP_KNOWLEDGE = (
    ...
    "- Agent7 (nightly ~10:15 PM): generates the nightly report for Sister Ellis (President's wife).\n"
    "- AgentQA (email-triggered): answers questions emailed to pmg.compass@gmail.com using the same Knowledge Base, and replies by email.\n"
    "- AgentReminder (weekly, Monday): emails compliance reminders to areas that missed the weekly Google Form.\n"
    "\n"
    "DATA FLOW:\n"
    "1. Missionaries fill the nightly or weekly Google Form -> the response lands in a RAW tab in the COMPASS_Main spreadsheet.\n"
