...
ES: dict[str, str] = {
    ...
    "Agent1C's leadership narratives.":
        ...
        "- **Google Drive (exportación Tableau Detail)** — un archivo CSV comprimido "
        "(gzip), no una pestaña de la hoja (17.4 MB sin comprimir, demasiado grande "
        "para mover como pestaña rápidamente). Su id de archivo vive en "
        "**AGENT_CONFIG → TABLEAU_DETAIL_FILE_ID**. La cuenta de servicio solo puede "
        "sobrescribirlo, no crearlo ni volver a compartirlo — si alguna vez se "
        "elimina, una persona debe subir uno nuevo y compartirlo como Editor con la "
        "cuenta de servicio otra vez, y luego actualizar esa clave de configuración.\n"
